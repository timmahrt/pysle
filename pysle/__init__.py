...
**praattools.py** contains useful utilities if you are working specifically with data stored in TextGrids.  Praat is a speech analysis tool that stores speech annotation data--such as phone labels--in TextGrids.
"""
